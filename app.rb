...
Job.create(name: 'Thief')
Job.create(name: 'Cleric')
...
Weapon.create(name: 'Dark Hand', desc: "The Darkwraiths, use the power of the dark soul to absorb humanity, an
art shared by this weapon,")
Weapon.create(name: 'Bandit\'s Knife', desc: "This wide single-edged shortsword is
the favorite of lowly thieves and bandits.")

Hero.create(name: 'Thor', weapon_id: 1, job_id: 1, race_id: 1)
Hero.create(name: 'Burneth', weapon_id: 2, job_id: 2, race_id: 3)
Hero.create(name: 'Gismor', weapon_id: 3, job_id: 3, race_id: 1)
